...
//append_imports_end
export class findAllUserDetailss {
  ...
  private constructor(
    ...
    this.serviceName = 'findAllUserDetailss';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findAllUserDetailss(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findAllUserDetailss_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findAllUserDetailss');
    //appendnew_flow_findAllUserDetailss_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findAllUserDetailss');

    this.app['post'](
      `${this.serviceBasePath}/dm/user_details/user_details/find-all`,
      cookieParser(),
    ...
    //appendnew_flow_findAllUserDetailss_HttpIn
  }
  //   service flows_findAllUserDetailss

  //appendnew_flow_findAllUserDetailss_start
  ...
  //appendnew_flow_findAllUserDetailss_Catch
}
