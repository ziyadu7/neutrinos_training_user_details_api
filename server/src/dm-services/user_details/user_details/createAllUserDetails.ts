...
//append_imports_end
export class createAllUserDetails {
  ...
  private constructor(
    ...
    this.serviceName = 'createAllUserDetails';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new createAllUserDetails(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_createAllUserDetails_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createAllUserDetails');
    //appendnew_flow_createAllUserDetails_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createAllUserDetails');

    this.app['post'](
      `${this.serviceBasePath}/dm/user_details/user_details/create-all`,
      cookieParser(),
    ...
    //appendnew_flow_createAllUserDetails_HttpIn
  }
  //   service flows_createAllUserDetails

  //appendnew_flow_createAllUserDetails_start
  ...
  //appendnew_flow_createAllUserDetails_Catch
}
