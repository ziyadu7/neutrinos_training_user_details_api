...
//append_imports_end
export class deleteAllUserDetailss {
  ...
  private constructor(
    ...
    this.serviceName = 'deleteAllUserDetailss';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new deleteAllUserDetailss(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_deleteAllUserDetailss_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: deleteAllUserDetailss');
    //appendnew_flow_deleteAllUserDetailss_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: deleteAllUserDetailss');

    this.app['post'](
      `${this.serviceBasePath}/dm/user_details/user_details/delete-all`,
      cookieParser(),
    ...
    //appendnew_flow_deleteAllUserDetailss_HttpIn
  }
  //   service flows_deleteAllUserDetailss

  //appendnew_flow_deleteAllUserDetailss_start
  ...
  //appendnew_flow_deleteAllUserDetailss_Catch
}
