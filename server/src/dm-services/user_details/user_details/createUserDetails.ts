...
export class createUserDetails {
  ...
  private constructor(
    ...
    this.serviceName = 'createUserDetails';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new createUserDetails(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_createUserDetails_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createUserDetails');
    //appendnew_flow_createUserDetails_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createUserDetails');

    this.app['post'](
      `${this.serviceBasePath}/dm/user_details/user_details/create`,
      cookieParser(),
    ...
    //appendnew_flow_createUserDetails_HttpIn
  }
  //   service flows_createUserDetails

  //appendnew_flow_createUserDetails_start
  ...
  //appendnew_flow_createUserDetails_Catch
}
